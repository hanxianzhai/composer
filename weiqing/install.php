				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<label class="radio-inline">
							<input type="radio" name="type" value="local"{$insTypes['local']}{$disabled}> 离线安装</label>
							<label class="radio-inline">
							<a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=cf742472b147019f0165f2c195c7c5a1d2b5b9f5ee95c9e6b2741fae8b51ad64"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="" title=""></a>
						</label>    
					</div>
				</div>
			</div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input class="form-control" type="text" name="db[prefix]" value="ims_" readonly="readonly" onclick="javascript:alert('不建议修改表前缀！')">
					</div>
				</div>
				<div class="form-group">
